...
import { Reference, referenceYupSchema } from '../utils/Validations';
  ...
  ({ skipReferences, setSkipReferences }) => {
    ...
    const handleAddReference = useCallback(
      (setFieldValue: (field: string, value: any) => void) => {
        ...
        setFieldValue('references', [...formData.references, newReference]);
      },
    ...
    return (
      <Formik
        initialValues={{ references: skipReferences ? [] : formData.references }}
        validationSchema={referenceYupSchema}
        enableReinitialize
        onSubmit={() => {
          ...
          <Form className="space-y-6">
            ...
            >
              <input
                ...
                onChange={() => {
                  const newSkipValue = !skipReferences;
                  setSkipReferences(newSkipValue);
                  if (newSkipValue) {
                    handleClearReferences(setFieldValue);
                  }
                }}
            ...
            {!skipReferences && (
              <>
                {formData.references.map((ref: Reference, index: number) => (
                  ...
                  >
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <button
                        type="button"
                        onClick={() => handleRemoveReference(index, setFieldValue)}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setFieldValue(`references[${index}].name`, e.target.value);
                          }}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setFieldValue(`references[${index}].relationship`, e.target.value);
                          }}
                          className="mt-1 w-full p-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                          aria-required="true"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setFieldValue(`references[${index}].company`, e.target.value);
                          }}
                          className="mt-1 w-full p-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                          aria-required="true"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setFieldValue(`references[${index}].contact`, e.target.value);
                          }}
                          className="mt-1 w-full p-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                          aria-required="true"
                ...
                <button
                  type="button"
                  onClick={() => handleAddReference(setFieldValue)}
